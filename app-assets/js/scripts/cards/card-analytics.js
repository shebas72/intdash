...
$(window).on("load", function(){
  ...
  var $white = '#fff';
    ...
    var sessionChartoptions = {
        ...
        labels: ['Subco Balance', 'Suppliers Balance'],
        stroke: { width: 0 },
   ...
   var orderChart = new ApexCharts(
    ...
    var customerChartoptions = {
        ...
        labels: ['Subco Balance', 'Suppliers Balance', 'Total Vendors'],
        series: [11, 15, 26],
        dataLabels: {
            enabled: false
        },
    ...
    var salesavgChartoptions_subbal = {
       ...
       colors: [$purple],
        ...
        xaxis: {
            ...
            categories: ['Supp A', 'Supp B', 'Supp C', 'Supp D', 'Supp E', 'Supp F', 'Supp G', 'Supp H', 'Supp I', 'Supp J', 'Supp K', 'Supp L', 'Supp M', 'Supp N', 'Supp O'],
            axisBorder: {
                show: false,
            },
            tickPlacement: 'on'
        ...
        series: [{
              ...
              data: [-2216238.13, 43822.5, -1114445, -574976.83, 11005, -409862, -26655, -265152, -70171, -77964, -410043, -35278.81, -49565, -150796, -180912]
          }],
  
      }
  
     var salesavgChart_subbal = new ApexCharts(
          document.querySelector("#sales-line-chart-subbal"),
          salesavgChartoptions_subbal
      );
  
      salesavgChart_subbal.render();
