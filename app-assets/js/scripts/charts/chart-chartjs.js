...
$(window).on("load", function () {
  ...
  //Get the context of the Chart canvas element we want to select
  var doughnutChartctx = $("#simple-doughnut-chart-180");
  var doughnutChartctx270 = $("#simple-doughnut-chart-270");
  ...
  var doughnutchartData = {
    labels: ["Customer 6", "Customer 7", "Customer 8", "Customer 11", "Customer 15", "Customer 18", "Customer 26"],
    datasets: [{
      label: "My First dataset",
      data: [11363050, 6235896, 23310077, 23875136, 7311752, 2419490, 7153420],
      backgroundColor: themeColors,
    }]
  };

  var doughnutchartData270 = {
    labels: ["Customer 8"],
    datasets: [{
      label: "My First dataset",
      data: [23310077],
  ...
  var doughnutChartconfig270 = {
    type: 'doughnut',

    // Chart Options
    options: doughnutchartOptions,

    data: doughnutchartData270
  };


  // Create the chart
  var doughnutSimpleChart = new Chart(doughnutChartctx, doughnutChartconfig);
  var doughnutSimpleChart270 = new Chart(doughnutChartctx270, doughnutChartconfig270);
